    ...
    return (
        <div className="min-w-screen">
            <div className='flex relative w-100 content-center justify-between mx-auto items-center '>
                <div className='h-10 w-10 bg-primary-light   rounded-full absolute z-0 left-10 top-10'></div>
                <div className='h-16 w-16 bg-primary-light rounded-full absolute z-0 left-1/3'></div>
            ...
            <div className='flex flex-col items-center justify-center h-screen pb-10'>
                <h3 className='text-xl font-bold pb-10 after'>Benefits of working with us</h3>
