    ...
    return (
        <div>
            ...
            <ReactModal
                ...
                className='rounded-sm focus:outline-none bg-gray-100 shadow-lg xl:p-8 xl:w-5/6 xl:h-5/6 top-16 lg:top-0 bottom-0 absolute right-0 left-0 m-auto'
            >
                <div className='w-full h-full flex flex-col'>
                    <div className='h-1/3 w-full flex text-center'>
                        <div className='flex flex-col justify-between w-full lg:w-2/3 h-full bg-cocoMall p-4'>
                            ...
                            <div className='lg:flex flex-col text-left text-white text-xs 2xl:text-sm     '>
                                <p>
