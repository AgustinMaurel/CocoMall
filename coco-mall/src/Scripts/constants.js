...
export const PRODUCT_CREATE_URL = `${BASE_URL}product/create`;
export const STORE_CREATE_URL = `${BASE_URL}store/create`;
export const STORES_URL = `${BASE_URL}store`;
export const SEARCH_URL = `${STORES_URL}filter`;
export const PRODUCT_URL = `${BASE_URL}product/create`;
